                ...
                <div className="container-fluid" style={{paddingLeft: "95px"}}>
                    ...
                    <div className="container"  style={{marginTop: '100px'}}>
                        {Object.size(ClassInfo) > 0 && userInfo !== null && (ClassInfo.owner === userInfo._id || ClassInfo.teacher.includes(userInfo._id)) ?
                            <button className="margin-top-bottom btn btn-dark-blue add-classwork-btn"
                                    onClick={openClasswork}>Add classwork +</button>
                            : null}
                    ...
                    <div className="classwork-modal" id="classwork" style={{marginTop: '50px'}}>
                        <div className="classwork-content container" style={{width: '50%'}}>
