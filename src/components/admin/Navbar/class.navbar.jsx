                ...
                <nav className="center bg-white text-dark topnav">
                    ...
                    <p className="col-3 option nav-ham mt-2 mb-2">
                        <p onClick={
                           ...
                           className="link">People</p>
                    </p>

                    <p className="col-3 option nav-ham"><p onClick={() => {
                        navigate.push(`/teacherAdmin/setting/`, {state: {classID: classInfo._id}})
                    }} className="link">Setting</p></p>
                </nav>
                : <nav className="center bg-white text-dark topnav">
                    <p className="col-4 nav-ham optc"><Link to={`/class/${classInfo._id}`}
                                                            className=" link">Stream</Link></p>
                    <p className="col-4 nav-ham optc"><Link to={`/class/${classInfo._id}/classwork`}
                                                            className="link">Classwork</Link></p>
                    <p className="col-4 nav-ham optc"><Link to={`/class/${classInfo._id}/people`}
                                                            className="link">People</Link></p>
                </nav>}
        </nav>
    )
}
