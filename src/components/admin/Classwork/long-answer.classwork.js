                    ...
                    <div className="container margin-top-bottom">
                        <div className="col-9">
                            ...
                            {classwork.author === userInfo._id ?
                                <div><h3><span className="link" style={{paddingLeft: "0"}} onClick={openClasswork}>Edit</span></h3>
                        ...
                        {classInfo.teacher && !(classInfo.teacher.includes(userInfo._id) || classInfo.owner === userInfo._id) ?
                                ...
                                {!answered ?
                                    <form className="box box-shadow" onSubmit={Answer}>
                                        ...
                                        <div className="form-group">
                                            <textarea rows="5" className="form-control" value={inputAnswer}
                            ...
                            <div className="col-3">
                                <div className="box box-shadow">
                                    ...
                                    <button className="form-control btn btn-dark" onClick={showAnswer}>See
                                        answers
                                    </button>
                                </div>
                            </div>}
